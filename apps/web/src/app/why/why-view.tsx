...
export const whyCopy: Readonly<Record<Language, WhyCopy>> = {
  ...
  ko: {
    ...
    intro: "탐지 뒤에 필요한 검증 단계와 그 한계를 설명합니다.",
    sectionUpstream: "01 · 감시 단계",
    sectionHandover: "02 · 사람의 판단",
    sectionAddition: "03 · 추가 검증",
    sectionPosition: "04 · 필요한 입력",
    sectionAuthority: "05 · 계층별 권한",
    sectionNotClaimed: "06 · 하지 않는 주장",
    ...
    readingText:
      "맨 위 띠는 이 단계의 범위 밖입니다. 결론만 받고, 최종 판단은 사람에게 남깁니다.",
    positionLede:
      "알림 뒤, 조사 판단 전에 놓입니다. 아래 세 입력이 있어야 패턴을 평가합니다. 매핑만 승인된 경우에는 정규화와 정본 해시만 반환합니다.",
    may: "할 수 있는 일.",
    mayNot: "할 수 없는 일.",
    statusLabel: "상태",
    ...
    sourcesLabel: "출처",
    sourcesLede: (mark) =>
      `저장소 밖의 사실에는 아래 출처를 붙였습니다. “${mark}”는 공표된 사실이 아닌 설계 전제입니다.`,
