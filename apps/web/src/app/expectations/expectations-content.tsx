...
const ko = {
  ...
  heading: "사례별 기대 결과",
  intro:
    "여기 값은 사례 리플레이에서 기준 실행을 확인할 때 씁니다. 고정된 소스와 승인된 매핑, 사례가 있는 경우 승인된 사례, 버전이 붙은 규칙을 설명합니다. 소스의 진실성이나 법적·인과적·투자 결론을 뒷받침하지는 않습니다.",
  guide: "새 세션에서 기준 실행 재현하기",
  output: "기대 출력",
  final: "최종 워크플로 상태",
  result: "패턴 결과",
  noManifest:
    "이 소스에는 커밋된 사례 manifest가 없습니다. 승인된 매핑과 결정론적 정규화 뒤에 워크플로가 끝나며, 패턴 gate나 결과는 평가하지 않습니다.",
